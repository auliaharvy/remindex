...
<div class="row mb-3">
    <div class="col-6">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->select($field_name)->placeholder($field_placeholder)->class('form-control select2-users')->attributes(["$required"]) }}
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="form-group">
            ...
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
            {{ html()->select($field_name)->placeholder($field_placeholder)->class('form-control select2-departments')->attributes(["$required"]) }}
        </div>
    </div>
</div>
<div class="row mb-3">
