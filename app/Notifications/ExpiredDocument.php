...
class ExpiredDocument extends Notification
{
    public $document;
    ...
    public function toMail($notifiable)
    {
        ...
        ->productIdentifier('Expired Document Notification')
        ...
        return (new MailMessage())
            ->subject('document Expired: ' . $this->document->name)
            ->line('document has been expired:')
    ...
    public function toDatabase($notifiable)
    {
        ...
        $text = 'Doucment Expired | <strong>'.$document->name.'</strong> on <strong>'.$document->user_name.'</strong>';

        $url_backend = route('backend.documents.show', $document->id);

        return [
            'title' => 'Doucment Expired!',
            'module' => 'Document',
